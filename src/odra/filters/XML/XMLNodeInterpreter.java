 ...
 * 
 */
public interface XMLNodeInterpreter{
	...
	public void closeElementScope( Element element ) throws FilterException, DatabaseException;

	public void openElementScope( Element element );
	 ...
	 */
	// TODO: (KK) How should we present unresolved OIDs?
