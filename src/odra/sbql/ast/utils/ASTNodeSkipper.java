...
/**
 * Visitor that searches AST traversing through nodes of given type and 
 * and stores theirs subnodes 
 * 
 * @author tkowals
 */

public class ASTNodeSkipper extends TraversingASTAdapter {

	protected Pattern pattern;
	protected Vector<ASTNode> result = new Vector<ASTNode>(); 
	
	public ASTNodeSkipper(Pattern pattern) {
		this.pattern = pattern;
	}
	
	public Vector<ASTNode> findChildNodes(ASTNode root) throws SBQLException {
